@echo off
echo Bygger SystemFlow Pro v1.0.3 Release med förbättrad hårdvarudetektering...
echo.
...
if exist "bin\Release\net9.0-windows\SystemFlow-Pro.exe" (
    echo ✅ LYCKADES! SystemFlow Pro v1.0.3 Release är nu kompilerad.
    echo.
    ...
    echo.
    echo 🎉 SystemFlow Pro v1.0.3 Release färdig!
    echo.
    echo Nya funktioner i denna version:
    echo • Förbättrad hårdvarudetektering för äldre system
    echo • Multipla detektionsstrategier (LibreHardwareMonitor + WMI + temperaturbaserad)
    echo • Bättre felmeddelanden med administratörsstatusinfo
    echo • Förbättrad kompatibilitet med äldre GPU/CPU-drivrutiner
    echo • Temperaturbaserad fläktskattning för äldre hårdvara
    echo • Detaljerad detektionsstatus i användargränssnittet
    echo.
    echo Release finns i: releases\v1.0.3\
    echo.
